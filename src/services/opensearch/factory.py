...
## explain @lru_cache(maxsize=1): This decorator is used to cache the result of the make_opensearch_client function, ensuring that only 
# one instance of the OpenSearch client is created and reused throughout the application.
@lru_cache(maxsize=1)
