...
from src.dependencies import BedrockDep, EmbeddingsDep, OpenSearchDep
...
async def ask_question(
    ...
    try:
        ...
        try:
            ...
            logger.error(f"Bedrock service unavailable: {e}")
...
async def ask_question_stream(
    ...
    async def generate_stream():
        try:
            ...
            # Stream the answer
            full_response = ""
            async for chunk in llm_client.generate_rag_answer_stream(query=request.query, chunks=chunks, model=request.model):
