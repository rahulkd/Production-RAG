...
import { MessageSources } from "@/components/rag/message-sources";
import { ModelSelect } from "@/components/rag/model-select";
...
const ThreadWelcome: FC = () => {
  return (
    <div className="aui-thread-welcome-root mb-6 flex flex-col items-center gap-2 px-4 text-center">
      ...
      <p className="aui-thread-welcome-message-subtitle text-muted-foreground fade-in slide-in-from-bottom-1 animate-in fill-mode-both text-sm duration-300">
        Ask a question and I&apos;ll answer from the indexed arXiv papers.
      </p>
    </div>
  );
};
    ...
    <ComposerPrimitive.Root className="aui-composer-root relative flex w-full flex-col">
      ...
      >
        <ComposerPrimitive.Input
          placeholder="Ask about the indexed arXiv papers..."
